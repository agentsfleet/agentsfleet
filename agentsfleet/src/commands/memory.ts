// `agentsfleet memory list|search` — read-only window into a zombie's durable
// memory over GET /v1/workspaces/{ws}/zombies/{zid}/memories.
//
// agentsfleet memory list   --zombie <id> [--category <name>] [--limit <n>] [--workspace <id>]
// agentsfleet memory search --zombie <id> <query> [--limit <n>] [--workspace <id>]
//
...
const USAGE_LIST =
  "usage: agentsfleet memory list --zombie <id> [--category <name>] [--limit <n>] [--workspace <id>]";
const USAGE_SEARCH =
  "usage: agentsfleet memory search --zombie <id> <query> [--limit <n>] [--workspace <id>]";
