...
| How does a new tenant get free usage? | [`billing_and_provider_keys.md`](./billing_and_provider_keys.md) §2.3 |
...
| **Free allowance** | Wallet credit only — the starter grant at signup. No pricing path consults a clock. [(more)](./billing_and_provider_keys.md#23-the-free-allowance-is-a-grant-not-a-window) |
