...
install flow   →   doctor --json (health)                  doctor --json (health)
                  ...
                  (billing show → wallet balance)           context_cap_tokens=256000}
