...
**Branch:** `feat/m194-grant-request-path` → continued on `feat/m194-acceptance-walk-verdict` (§4's walk needs the surface a person answers the card on, so §5 was folded into this spec rather than opened as a second stream)
