...
- **Dimension 4.2** — **IN_PROGRESS** — `src/agentsfleetd/**` is removed and no reference survives outside the written record (`docs/v2/`, `docs/v1/`) → Test `no path under src/agentsfleetd is referenced after the deletion`
...
| R6 | Nothing references it (§4.2) | `git grep -l "src/agentsfleetd" -- ':!docs/v2' ':!docs/v1'` | no output | P0 | |
