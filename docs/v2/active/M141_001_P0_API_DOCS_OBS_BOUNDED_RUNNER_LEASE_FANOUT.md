...
| `src/agentsfleetd/queue/redis_fleet_test.zig` | CREATE | Receive the decode tests currently inlined at the bottom of `redis_fleet.zig`, which sits at exactly the 350-line cap and cannot absorb an edit until they move. |
