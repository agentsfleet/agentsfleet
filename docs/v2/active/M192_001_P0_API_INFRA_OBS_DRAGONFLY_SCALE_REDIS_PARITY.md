...
- **Dimension 5.1**: a non-cluster seed, bad TLS trust, wrong credentials, missing capability or unsafe eviction refuse boot before any work is accepted → Test `test_datastore_preflight_refuses_invalid_configuration`.
