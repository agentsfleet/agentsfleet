...
- **Dimension 5.4**: session verify, approve and abort keep single-use semantics on the cluster → Test `test_session_transitions_preserve_single_use_on_the_cluster`.
...
| 5.4 | integration | `test_session_transitions_preserve_single_use_on_the_cluster` | Verify, approve, abort are single-use on the cluster. |
