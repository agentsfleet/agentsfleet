...
- **Dimension 4.2** — IN_PROGRESS —  `runner/` clears 95%: `daemon/lease_run.zig` (40 dark), `child_supervisor.zig` (25), `engine/runner.zig` (24), then the tail until the folder rate clears 95 → Tests per file, `test_…` per behaviour
