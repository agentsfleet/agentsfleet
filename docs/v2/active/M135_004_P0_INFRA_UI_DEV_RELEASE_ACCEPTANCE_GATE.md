...
- **Consults** — Architecture / Legacy-Design / gate-flag triage:
  ...
  - The `/v1/fleets/streams`-adjacent stream 401 (UZ-AUTH-002) Indy raised mid-session is product auth-flow on the workspace-stream surface — routed to the M133 hardening stream, not this workstream.
