...
### §4 — A person watches it work, and the evidence is a file — DONE (4.1, 4.2 mechanism) · 4.2 verdict + 4.3 sign-off are the first post-merge actions, per 4.2's own amendment
