...
### §4 — A person watches it work, and the evidence is a file — DONE (4.1 playbook, 4.2 mechanism: verdict file format + `01_verdict_check.sh`) · the walk itself, 4.2's verdict and 4.3's sign-off are **M193_001**'s
