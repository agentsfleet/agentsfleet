...
pub const core_agents_sql = @embedFile("007_core_agents.sql");
pub const core_agent_sessions_sql = @embedFile("008_core_agent_sessions.sql");
pub const core_agent_approval_gates_sql = @embedFile("009_core_agent_approval_gates.sql");
...
pub const agent_execution_telemetry_sql = @embedFile("014_agent_execution_telemetry.sql");
...
pub const agent_events_sql = @embedFile("018_agent_events.sql");
