//! agentsfleetd-side runner control-plane orchestration — the `renew` verb.
//!
...
/// identical rates.
fn buildMeter(conn: *pg.Conn, lease: Lease, body: protocol.RenewRequest) renewal_meter.MeterInputs {
