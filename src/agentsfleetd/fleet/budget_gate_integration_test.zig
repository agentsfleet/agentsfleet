...
//!
//! Note on spend: these tests seed `credit_deducted_nanos` directly rather than
//! driving a fleet through the HTTP path to accrue it. That is what the gate
//! actually reads, and its decision is independent of how the telemetry rows
//! came to exist.
