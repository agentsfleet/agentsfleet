...
//
// The balance-exhausted HTTP path (spec 1.1) has its row mechanics + label
// spelling pinned here via markBlocked, and its gate wiring exercised through
// the same blockEvent path as the other refusals.
...
pub const AGENTSFLEET_GATED = "0195c9da-1e2a-7f13-8abc-2b3e1e0d7c03";
