...
pub const Route = union(enum) {
    ...
    workspace_secrets: []const u8, // GET|POST /v1/workspaces/{ws}/credentials
    workspace_secret: matchers.WorkspaceSecretRoute, // PATCH|DELETE /v1/workspaces/{ws}/credentials/{name}
