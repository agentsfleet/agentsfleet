...
pub const ERR_CLI_CREDENTIAL_EXCHANGE_FAILED = "UZ-AUTH-025";
...
pub const ERR_REPAIR_SPEND_EXHAUSTED = "UZ-REPAIR-013";
pub const ERR_REPAIR_PROVENANCE_REFUSED = "UZ-REPAIR-014";
