...
pub const ENTRIES = [_]Entry{
    ...
    // Named constants live in errors/library_codes.zig, split out because
    // error_registry.zig sits exactly on the 350-line cap (RULE FLL) — same
    // reason error_registry_mirror_pin.zig was split.
