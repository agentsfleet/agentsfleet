...
pub const ENTRIES = [_]Entry{
    ...
    e("UZ-WH-020", .unauthorized, "Webhook credential not configured", "Create a random webhook secret of at least 32 bytes. Store it as this source's webhook_secret, set the same value upstream, then resend."), // reachable: no — external webhook sender sees this, not the dashboard
