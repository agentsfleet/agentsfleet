...
//!
//! Holds the ProbedCredential record, the vault probe that turns a tenant's
//! credential_ref into a validated {provider, api_key, model, base_url}
...
const log = logging.scoped(.credential_probe);
