...
test {
    ...
    _ = @import("http/pool_exhaustion_runner_integration_test.zig");
    ...
    _ = @import("state/fleet_detail_grant_alloc_test.zig");
    _ = @import("state/signup_teardown_alloc_test.zig");
    ...
    _ = @import("http/handlers/fleet/runner_selftest_race_integration_test.zig");
