...
// `ui/packages/website/public/` may not exist on a fresh checkout because git
// does not track empty directories. Recreate it before writing generated files
// so local checkouts and Continuous Integration (CI) do not fail with ENOENT.
