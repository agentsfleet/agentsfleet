...
export default function Terms() {
  return (
    ...
    >
      ...
      <List className="pl-6 text-text-muted m-0">
        <ListItem>agentsfleet is free to try during early access. See the Pricing section on the home page for current rates and trial details. Each new account receives a starter credit; the specific value is displayed on the Pricing page. Stealth-mode testing rate — will rise after General Availability.</ListItem>
