 ...
 * docs: ~68ch measure, Instrument Sans section headings and body.
 */
export default function Privacy() {
  return (
    ...
    >
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">1. Information we collect</h2>
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">2. Information we do not collect</h2>
      <List className="pl-6 text-text-muted m-0">
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">3. How we use your information</h2>
      <List className="pl-6 text-text-muted m-0">
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">4. Data retention</h2>
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">5. Third-party services</h2>
      <List className="pl-6 text-text-muted m-0">
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">6. Cookies and local storage</h2>
      ...
      <h2 className="font-sans text-heading mt-6 mb-0 font-semibold">7. Contact</h2>
      <p className="text-text-muted m-0">
