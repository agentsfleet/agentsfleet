...
// reserves the trigger footprint with a button-sized Skeleton (h-8 = the
// `size="sm"` Button height) to avoid a layout shift while the chunk loads after
// hydration. Keeps the dialog body out of the /admin/runners initial bundle.
