> **Generated by `orly`.**
> Profile: `agentsfleet`. Ruleset digest: `5423a6c87053069f7d34a7bc305b24bc64b4ac2d798374b20d9d24214b24831d`.
...
| `language.python` | .py |
| `language.shell` | .sh |
| `domain.sql` | path or action trigger |
| `domain.http` | path or action trigger |
| `domain.auth` | path or action trigger |
| `domain.documentation` | path or action trigger |
| `domain.changelog` | path or action trigger |
| `domain.architecture` | path or action trigger |
| `workflow.specifications` | path or action trigger |
| `workflow.governance` | path or action trigger |
...
| `verify.integration` | `make test-integration` |
| `verify.lint` | `make lint-all` |
| `verify.memory` | `make memleak` |
