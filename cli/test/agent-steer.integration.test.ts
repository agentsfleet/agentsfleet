// Integration + unit coverage for src/commands/agent_steer.ts (part 1).
...
//
// Part 2 (error paths, poll, REPL) lives in agent-steer-errors.integration.test.ts.
...
// ── Unit: undefined agent_id validation (lines 284-286) ──────────────────

describe("steer — undefined agent_id validation (lines 284-286)", () => {
  test("steerEffectFromArgs with undefined agentId fails with ValidationError", async () => {
