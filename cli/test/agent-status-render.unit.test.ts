...
// projects each agent's events_processed and formats budget_used_nanos as USD
// via the shared billing formatter — guarding the field contract with the
// server's GET /agents aggregates (events_processed + budget_used_nanos).

import { describe, test, expect } from "bun:test";
import { Effect, Exit, Layer, Option, Redacted } from "effect";

import { statusEffect } from "../src/commands/agent.ts";
...
describe("agentsfleet status — per-agent events + budget", () => {
