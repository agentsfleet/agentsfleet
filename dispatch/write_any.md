...
**Family:** Source-rot prevention. **Source:** `AGENTS.orly.md` (project-side guard). Related: **RULE TST-NAM** (test identifiers are milestone-free) in `docs/greptile-learnings/RULES.md`.
...
**Exempt paths** (IDs allowed): `docs/`, `**/*.md` outside `node_modules/`/`vendor/`, `CLAUDE.md`/`AGENTS.orly.md`/`audits/agents-md.md`.
...
**Family:** Constant discipline. **Source:** `AGENTS.orly.md` conformance enforcement
...
**Family:** Legacy-control. Sibling rules: **RULE NDC**, **RULE NLR**, **RULE NLG**. **Source:** `AGENTS.orly.md` (project-side guard, not a greptile-derived rule).
