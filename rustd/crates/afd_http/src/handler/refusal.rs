//! The refusal an HTTP handler carries out through `?`.
//!
...
impl Refusal {
    ...
    pub fn at<E: Refusable>(event: &'static str) -> impl FnOnce(E) -> Self {
    ...
    #[must_use]
    pub fn coded(code: afd_core::error_code::ErrorCode, detail: &'static str) -> Self {
        Self(Box::new(
    ...
    pub fn at_stream_ceiling(carrying: usize, capacity: usize) -> Self {
    ...
    pub fn conflict_at<E: Refusable>(
        event: &'static str,
    ...
    pub fn conflict_detailed<E: Refusable>(
        event: &'static str,
        detail: String,
        current_state: &'static str,
    ) -> impl FnOnce(E) -> Self {
