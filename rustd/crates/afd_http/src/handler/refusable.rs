//! What a service failure tells the HTTP edge, and the one line every refusal
//! leaves behind.
//!
...
pub fn refuse<E: Refusable + ?Sized>(error: &E, event: &'static str) -> Response {
