...
use {
    ...
    afd_cron as _, afd_crypto as _, afd_datastore as _, afd_db as _, afd_events as _,
    afd_fleet as _, afd_fleet_lifecycle as _, afd_fleet_ops as _, afd_identity as _,
    afd_ingress as _, afd_library as _, afd_runner as _, afd_sse as _, afd_state as _,
