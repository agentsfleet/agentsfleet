...
use super::Refusal;
use super::webhook::verify_platform::APPROVAL_IDENTITY;
...
pub(crate) fn provider_of(segment: &str) -> Result<Provider, Refusal> {
    Provider::parse(segment)
        .ok_or_else(|| Refusal::coded(error_code::CONNECTOR_UNKNOWN, DETAIL_UNKNOWN_PROVIDER))
}
