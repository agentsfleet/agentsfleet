...
pub use self::detail::{
    ...
    DETAIL_EVENT_MALFORMED, DETAIL_GATE_REFERENCE_UNWRITABLE, DETAIL_HOST_ID_BOUNDS,
    DETAIL_PROVIDER_UNRESOLVED, DETAIL_QUEUE_UNAVAILABLE, DETAIL_REGISTRATION_FAILED,
    DETAIL_REGISTRY_ALLOWLIST, DETAIL_RUNNER_NOT_FOUND, DETAIL_VAULT_DATA_INVALID,
};
