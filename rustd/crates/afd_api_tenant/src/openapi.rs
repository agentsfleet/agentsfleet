...
#[openapi(paths(
    ...
    crate::handler::auth::session::approve,
    ...
    crate::handler::auth::session::verify,
    ...
    crate::handler::schedule::create,
    crate::handler::schedule::list,
    crate::handler::schedule::one,
    crate::handler::schedule::patch,
    crate::handler::schedule::purge,
    crate::handler::schedule::sync,
    ...
    crate::handler::tenant::model_entry::create,
    crate::handler::tenant::model_entry::list,
    crate::handler::tenant::model_entry::remove,
    crate::handler::tenant::model_entry::update,
    crate::handler::tenant::models::catalogue,
    crate::handler::tenant::provider::apply,
    crate::handler::tenant::provider::reset,
