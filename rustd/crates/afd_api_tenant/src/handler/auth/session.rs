...
#[cfg_attr(feature = "openapi", utoipa::path(
    ...
    description = concat!(
        ...
        "An expired session returns 401 with a stable error code; a used or ",
        "cancelled one returns 410. ",
    ),
    params(
...
#[cfg_attr(feature = "openapi", utoipa::path(
    ...
    description = concat!(
        ...
        "work until its short-lived JWT expires. This endpoint clears ",
        "in-flight login sessions only. ",
    ),
    responses(
