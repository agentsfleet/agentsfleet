...
/// the `source`, never stringified into a message.
...
/// `afd_datastore::Error::is_unavailable`, so one sample would leave half of
/// that decision — and the 503-versus-500 the HTTP edge turns on — unread.
///
/// # Panics
