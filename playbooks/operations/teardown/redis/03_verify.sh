...
echo ""
echo "NOTE: FLUSHALL removes the per-agent event streams and their"
echo "agent_lease consumer groups. No manual re-priming is needed —"
echo "agentsfleetd recreates each one on demand at agent-create time."
