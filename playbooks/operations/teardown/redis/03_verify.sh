...
echo ""
echo "NOTE: Redis Streams consumer groups (run_queue) and any other"
echo "keys are removed by FLUSHALL. Re-run the priming_infra stream"
echo "bootstrap to recreate consumer groups before serving traffic."
