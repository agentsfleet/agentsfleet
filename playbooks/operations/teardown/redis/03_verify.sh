...
echo ""
echo "NEXT: restart or redeploy every agentsfleetd machine before traffic."
echo "Startup recreates connector:outbound; normal writes recreate"
echo "fleet:{fleet_id}:events, fleet_lease, and fleet:ready."
